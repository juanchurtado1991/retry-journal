...
/**
 * Deliberately hostile Ktor server used to exercise [com.retryjournal.client.RetryJournalOfflineQueuePlugin]
 * and [com.retryjournal.engine.RetryJournalEngine] under real chaos, per validation plan:
...
fun Application.chaosModule() {
    ...
    routing {
        ...
        // interesting path (RetryJournalOfflineQueuePlugin capturing a real multipart body correctly)
