...
internal object AppConstants {
    const val QUEUE_FILE_NAME: String = "retry-journal-queue.bin"
    const val DEAD_LETTER_FILE_NAME: String = "retry-journal-dead-letter.bin"
     ...
     * listed under BGTaskSchedulerPermittedIdentifiers in Info.plist — see retry-sample/iosApp/. */
    const val IOS_BACKGROUND_TASK_ID: String = "retry_journal_task"
    ...
    const val DESKTOP_DATA_DIRECTORY_NAME: String = ".retry-journal-sample"

    const val DESKTOP_WINDOW_TITLE: String = "RetryJournal — Demo (Desktop)"
