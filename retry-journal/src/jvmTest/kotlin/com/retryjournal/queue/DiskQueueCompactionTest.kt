...
/** Covers [com.retryjournal.queue.disk.DiskQueueCompactor] — reclaiming dead space once the dead-byte ratio crosses
 * [com.retryjournal.queue.disk.DiskQueueConstants.COMPACTION_DEAD_RATIO_THRESHOLD], and that ids/sequence numbers survive it. */
