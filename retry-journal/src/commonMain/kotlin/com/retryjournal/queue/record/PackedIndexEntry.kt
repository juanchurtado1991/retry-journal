...
import com.retryjournal.queue.disk.DiskQueueConstants.INDEX_OFFSET_BITS

/** Packs a record's on-disk length and byte offset into the single [Long]
 * [DiskQueue][com.retryjournal.queue.disk.DiskQueue] keeps per live sequence id — see
 * [DiskQueue][com.retryjournal.queue.disk.DiskQueue]'s own `liveOffsetsBySequence` doc for the
 * bit layout. */
