...
import com.retryjournal.queue.record.Crc32
 ...
 * removal has not finished yet — lets [com.retryjournal.engine.HeadReplayExecutor] skip
 * the network round-trip and retry [com.retryjournal.queue.disk.DiskQueue.completeHeadReplay]
 * only.
 *
