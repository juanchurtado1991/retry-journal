...
import com.retryjournal.engine.SyncEngineConstants.REPLAY_CLIENT_HAS_QUEUE_PLUGIN_MESSAGE
...
/**
 * Replays one queued [QueueEntry] over the wire — the only place [RetryJournalEngine] touches Ktor
...
internal class HttpReplayer {
     ...
     * behind it: [RetryJournalEngine.flush] always starts from the oldest entry, so an uncaught
