...
/** Packs a record's on-disk length and byte offset into the single [Long] [DiskQueue] keeps per
 * live sequence id — see [DiskQueue]'s own `liveOffsetsBySequence` doc for the bit layout. */
