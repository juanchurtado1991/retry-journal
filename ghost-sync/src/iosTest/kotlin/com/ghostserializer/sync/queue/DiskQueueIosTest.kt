...
class DiskQueueIosTest {
    private val dir = "/tmp/ghost-sync-ios-test".toPath()

    @BeforeTest
    fun setUp() {
        com.ghost.serialization.Ghost.addRegistry(com.ghost.serialization.generated.GhostModuleRegistry_ghost_sync.INSTANCE)
